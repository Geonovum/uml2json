...
NOTE: The URL "https://FIXME/schema_definitions.json" is preliminary and will likely change during the OGC publication process for this document.
...
include::../requirements/entitytype/PERM001.adoc[]
