...
* If a (direct or inherited, but ignoring redefined) UML property of the feature type has tag "primaryGeometry" with value equal to and ignoring case "true", then that property is the primary geometry of the feature type.
