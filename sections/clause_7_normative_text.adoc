...
#TODO JE# Document the UML profile, i.e., stereotypes from ISO 19103:2015 and ISO 19109:2015, plus additional ones - as well as the tagged values that are relevant for the JSON Schema encoding rules.
