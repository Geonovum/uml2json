...
#TBD# Should we omit the measure types, since the encoding as just real might be a bit restrictive (omitting any uom information). If not, we should probably list them all.
...
#TODO# What are the intended final file locations for the JSON-FG JSON Schema files- the URLs with "beta." removed?
